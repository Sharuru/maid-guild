...
-- ----------------------------
DROP SEQUENCE "api_key_record_id_seq";
CREATE SEQUENCE "api_key_record_id_seq"
 ...
 START 6
 CACHE 1;
SELECT setval('"public"."api_key_record_id_seq"', 6, true);

-- ----------------------------
-- Sequence structure for city_id_record_id_seq
-- ----------------------------
DROP SEQUENCE "city_id_record_id_seq";
...
-- ----------------------------
DROP SEQUENCE "moudle_list_record_id_seq";
...
-- ----------------------------
DROP SEQUENCE "test_record_id_seq";
